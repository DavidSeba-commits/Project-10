...
public class Main {
    public static void main(String[] args) {
        ...
        UserInfo user2 = new UserInfo("David SEBA", "24/1619/BIT-S", "Informational Technology", "+243 998 977 052");
        UserInfo user3 = new UserInfo("Charlie Brown", "25/9089/BM-S", "Business Management", "+256 789 098 675");
        ...
        System.out.println();
        userManager.displayUser("David SEBA", true, true, true, true);
